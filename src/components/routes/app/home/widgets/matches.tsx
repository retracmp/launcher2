...
const RecentMatch = (props: RecentMatchProps) => {
  ...
  return (
    <div className="overflow-hidden whitespace-nowrap overflow-ellipsis flex flex-row items-center p-2 gap-1 w-full bg-neutral-800/10 rounded-xs border-[#2e2e2e]/50 border-1 border-solid text-neutral-700">
