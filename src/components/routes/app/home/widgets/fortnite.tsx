...
const FortniteWidget = () => {
  ...
  return (
    <div className="relative flex flex-col p-2 gap-0.5 min-w-[45%] w-[70%] @max-2xl:w-[100%] aspect-[5/2.4] bg-neutral-800/10 rounded-sm border-neutral-700/40 border-1 border-solid overflow-hidden backdrop-blur-sm">
