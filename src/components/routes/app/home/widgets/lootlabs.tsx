...
const LootLabsWidget = () => {
  ...
  return (
    <div className="relative flex flex-col p-2 gap-0.5 w-[70%] @max-xl:w-[100%] @max-xl:h-40 bg-neutral-800/10 rounded-sm border-neutral-700/40 border-1 border-solid">
