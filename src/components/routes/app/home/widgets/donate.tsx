...
const DonatedMessage = (type: DonatedMessageProps) => {
  return (
    <div
      className="flex flex-row gap-1 w-full min-h-min h-full p-2 bg-neutral-800/10 rounded-sm border-neutral-700/40 border-1 border-solid text-center items-center justify-center"
      style={{
...
const NotDonatedMessage = () => {
  ...
  return (
    <div
      className="flex flex-row flex-wrap gap-1 w-full min-h-min h-full p-2 bg-neutral-800/10 rounded-sm border-neutral-700/40 border-1 border-solid hover:underline cursor-pointer text-neutral-300/60 text-center items-center justify-center"
      style={{
        backgroundImage:
