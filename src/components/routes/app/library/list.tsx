...
const FortniteBuildList = (props: FortniteBuildProps) => {
  ...
  return (
    ...
    >
      <motion.div
        className={`group flex flex-row items-center w-full p-2.5 px-2 gap-2 rounded-sm border-neutral-700/10 border-[1px] border-solid overflow-hidden bg-neutral-700/10 hover:bg-neutral-700/15 transition-colors duration-75 backdrop-blur-md z-[200]`}
        variants={{
