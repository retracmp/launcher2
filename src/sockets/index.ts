...
import { make, RetracSocket } from "src/sockets/retrac_socket";
...
const create_socket_manager = (): UseBoundStore<StoreApi<SocketManager>> => {
  return create<SocketManager>()((set, get) => ({
    socket: null,
    event_listeners: {},
...
export const useLauncherSocket = create_socket_manager();
export const useMatchmakerSocket = create_socket_manager();
