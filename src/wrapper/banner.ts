...
export const bannerColours = {
  red: [
    "flex flex-row items-center p-1.5 w-full bg-red-500/20 border-1 border-solid border-red-500/20 rounded-sm h-[2.125rem]",
    "text-neutral-300 font-plex text-[14px] leading-3.5 text-base",
    "text-red-200 hover:bg-red-500/20",
  ],
  blue: [
    "flex flex-row items-center p-1.5 w-full bg-blue-500/20 border-1 border-solid border-blue-500/20 rounded-sm h-[2.125rem]",
    "text-neutral-300 font-plex text-[14px] leading-3.5 text-base",
    "text-blue-200 hover:bg-blue-500/20",
  ],
  green: [
    "flex flex-row items-center p-1.5 w-full bg-green-500/20 border-1 border-solid border-green-500/20 rounded-sm h-[2.125rem]",
    "text-neutral-300 font-plex text-[14px] leading-3.5 text-base",
    "text-green-200 hover:bg-green-500/20",
  ],
  yellow: [
    "flex flex-row items-center p-1.5 w-full bg-yellow-500/20 border-1 border-solid border-yellow-500/20 rounded-sm h-[2.125rem]",
    "text-neutral-300 font-plex text-[14px] leading-3.5 text-base",
    "text-yellow-200 hover:bg-yellow-500/20",
  ],
  pink: [
    "flex flex-row items-center p-1.5 w-full bg-pink-500/20 border-1 border-solid border-pink-500/20 rounded-sm h-[2.125rem]",
    "text-neutral-300 font-plex text-[14px] leading-3.5 text-base",
